...
| `sentry.web.customCA.secretName`              | Allows mounting a custom CA secret into the web pods                                                                                                                | `nil`                          |
| `sentry.web.customCA.item`                    | Key of CA cert object within the secret                                                                                                                             | `ca.crt`                       |
| `sentry.worker.customCA.secretName`           | Allows mounting a custom CA secret into the worker pods                                                                                                             | `nil`                          |
| `sentry.worker.customCA.item`                 | Key of CA cert object within the secret                                                                                                                             | `ca.crt`                       |
